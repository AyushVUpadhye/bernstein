...
- **Broad and local.** 52 selectable CLI agent adapters, including a generic `--prompt` wrapper, file-based state, no SaaS hop, no third-party data plane.
